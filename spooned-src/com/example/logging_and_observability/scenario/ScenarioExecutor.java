...
public class ScenarioExecutor {
    ...
    private Product getRandomProduct() {
        if (testProducts.isEmpty())
            throw new IllegalStateException("No test products available");
    ...
    private void executeScenario5_WindowShopper() {
        ...
        List<Product> favorites = // Mechanical Keyboard
        // Webcam HD
        // Mechanical Keyboard RGB
        // Noise Cancelling Headphones
        // iPad Pro
        Arrays.asList(testProducts.get(6), testProducts.get(7), testProducts.get(12), testProducts.get(13), testProducts.get(14));
