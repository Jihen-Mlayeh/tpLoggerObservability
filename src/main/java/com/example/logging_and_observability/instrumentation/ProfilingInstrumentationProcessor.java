...
public class ProfilingInstrumentationProcessor extends AbstractProcessor<CtMethod<?>> {
    ...
    private static final List<String> READ_OPERATIONS = Arrays.asList(
    ...
    public boolean isToBeProcessed(CtMethod<?> method) {
        ...
        return className.endsWith("ProductService") &&
                (READ_OPERATIONS.contains(methodName) || WRITE_OPERATIONS.contains(methodName));
    }
